...
ecran.setText("0");
    ...
    private void initComponents() {
        ...
        ecran.setFont(new java.awt.Font("Cantarell", 1, 24)); // NOI18N
        ecran.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        ecran.setToolTipText("");
        ecran.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        ecran2.setBackground(new java.awt.Color(0, 0, 102));
        ecran2.setFont(new java.awt.Font("Cantarell", 1, 15)); // NOI18N
        ecran2.setForeground(new java.awt.Color(0, 0, 102));
        ecran2.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        ecran2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(ecran, javax.swing.GroupLayout.PREFERRED_SIZE, 254, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(ecran2, javax.swing.GroupLayout.PREFERRED_SIZE, 254, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(ecran, javax.swing.GroupLayout.PREFERRED_SIZE, 57, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(ecran2, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
        ...
        ecran2.getAccessibleContext().setAccessibleName("ecran2");
...
if(operateur.equals("+") || operateur.equals("-") || operateur.equals("*") || operateur.equals("/") ){
  ecran.setText(String.valueOf(ecran.getText()+"1"));
...
operateur="-";         // TODO add your handling code here:
ecran.setText("");
ecran2.setText(ecran2.getText()+"-");
...
operateur="C";         // TODO add your handling code here:
ecran.setText("");
ecran2.setText("");
chiffre1=0;
 chiffre2=0;
...
if(operateur.equals("+") || operateur.equals("-") || operateur.equals("*") || operateur.equals("/") ){
  ecran.setText(String.valueOf(ecran.getText()+"2"));
chiffre2 = Double.valueOf(ecran.getText()).doubleValue();  
}
else{
ecran.setText(String.valueOf(ecran.getText()+"2"));
...
if(operateur.equals("+") || operateur.equals("-") || operateur.equals("*") || operateur.equals("/") ){
  ecran.setText(String.valueOf(ecran.getText()+"3"));
chiffre2 = Double.valueOf(ecran.getText()).doubleValue();  
}
else{
ecran.setText(String.valueOf(ecran.getText()+"3"));
...
if(operateur.equals("+") || operateur.equals("-") || operateur.equals("*") || operateur.equals("/") ){
  ecran.setText(String.valueOf(ecran.getText()+"4"));
chiffre2 = Double.valueOf(ecran.getText()).doubleValue();  
}
else{
ecran.setText(String.valueOf(ecran.getText()+"4"));
...
if(operateur.equals("+") || operateur.equals("-") || operateur.equals("*") || operateur.equals("/") ){
  ecran.setText(String.valueOf(ecran.getText()+"5"));
chiffre2 = Double.valueOf(ecran.getText()).doubleValue();  
}
else{
ecran.setText(String.valueOf(ecran.getText()+"5"));
...
if(operateur.equals("+") || operateur.equals("-") || operateur.equals("*") || operateur.equals("/") ){
  ecran.setText(String.valueOf(ecran.getText()+"6"));
chiffre2 = Double.valueOf(ecran.getText()).doubleValue();  
}
else{
ecran.setText(String.valueOf(ecran.getText()+"6"));
...
if(operateur.equals("+") || operateur.equals("-") || operateur.equals("*") || operateur.equals("/") ){
  ecran.setText(String.valueOf(ecran.getText()+"7"));
chiffre2 = Double.valueOf(ecran.getText()).doubleValue();  
}
else{
ecran.setText(String.valueOf(ecran.getText()+"7"));
...
if(operateur.equals("+") || operateur.equals("-") || operateur.equals("*") || operateur.equals("/") ){
  ecran.setText(String.valueOf(ecran.getText()+"8"));
chiffre2 = Double.valueOf(ecran.getText()).doubleValue();  
}
else{
ecran.setText(String.valueOf(ecran.getText()+"8"));
...
if(operateur.equals("+") || operateur.equals("-") || operateur.equals("*") || operateur.equals("/") ){
  ecran.setText(String.valueOf(ecran.getText()+"9"));
chiffre2 = Double.valueOf(ecran.getText()).doubleValue();  
}
else{
ecran.setText(String.valueOf(ecran.getText()+"9"));
...
if(operateur.equals("+") || operateur.equals("-") || operateur.equals("*") || operateur.equals("/") ){
  ecran.setText(String.valueOf(ecran.getText()+"0"));
chiffre2 = Double.valueOf(ecran.getText()).doubleValue();  
}
else{
ecran.setText(String.valueOf(ecran.getText()+"0"));
